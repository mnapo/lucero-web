...
const components: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    title: "Navigator",
    href: "/",
    description: "Easily add data views, user interaction and links between screens",
  },
  {
    title: "Hover Card",
    href: "/",
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <NavigationMenuLink asChild>
                  <a
                    ...
                    <p className="text-sm leading-tight text-muted-foreground">
                      Sharp designed components that you can use into your apps.
              ...
              <ListItem href="/" title="Introduction">
                Framework first screenshot
              </ListItem>
              <ListItem href="/" title="Installation">
                How to install dependencies and structure your project
              </ListItem>
              <ListItem href="/" title="Navigator">
                Add different screens to your app
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
